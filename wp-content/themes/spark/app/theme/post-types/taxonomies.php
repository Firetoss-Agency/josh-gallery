...
add_action('init', function () {
    ...
    $plural_name     = 'Tags'; // human readable
    $singular_name   = 'Tag'; // human readable
    $slug            = 'tag'; // use hyphens
    $registered_name = 'tag'; // use underscores
    $post_type       = ['attachment']; // post-type(s) $registered_name(s)
